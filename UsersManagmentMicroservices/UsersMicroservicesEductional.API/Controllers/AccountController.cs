...
namespace UsersMicroservicesEductional.API.Controllers
{
    /// <summary>
    ...
    public class AccountController : ControllerBase
    {
        ...
        public AccountController(
            ...
            ILogger<AccountController> logger) // Added ILogger to constructor
        {
        ...
        public async Task<ActionResult<AuthenticationResponse>> RegisterCleintAsync([FromForm] RegisterDTO registerDTO)
        {
