...
namespace UsersMicroservicesEductional.Core.Services
{
    public class AuthenticationServices : IAuthenticationServices
    {
        ...
        private async Task<string> CreateFileAsync(IFormFile file)
        {
        ...
        public async Task<AuthenticationResponse> RegisterClientAsync(RegisterDTO clientRegisterDTO)
        {
            ...
            user.ProfilePictureUrl = await CreateFileAsync(clientRegisterDTO.ProfilePicture);
